...
Al no tener acceso con privilegios de profesor al servicio Moodle de la universidad, se ha tenido que instalar un servidor de pruebas en localhost. Las comprobaciones en un entorno real lo han realizado varios profesores docentes de la universidad, entre ellos el tutor, en UBUVirtual.

Se ha usado la versión \textbf{3.5.4+} de Moodle al no estar disponible para descargar la \textbf{3.5.1} instalada en UBUVirtual.

También se ha empleado una versión de prueba oficial del propio equipo de desarrollo \href{https://school.demo.moodle.net}{\textit{Mount Orange School}} en la versión \textbf{3.7}, que probablemente se use en la aula virtual de la Universidad de Burgos en el futuro.
...
El desarrollo, al igual que el anterior proyecto UBUGrades y UBULogs, se ha seguido con Java 8 al ser una edición con \href{https://www.oracle.com/technetwork/java/java-se-support-roadmap.html
}{soporte extendido}.
...
Eclipse es uno de los entornos de desarrollo (IDE) más famosos, junto con
...
MiKTex es una distribución de \LaTeX diferentes plataformas de sistemas operativos, es de código libre y viene incluido con múltiples paquetes de tipografías y macros.

\subsection{TeXstudio}

TeXstudio es un entorno de desarrollo integrado (IDE) de edición de texto, código abierto con resaltado de sintaxis orientado a la creación de documentos \LaTeX.
...
\subsection{Gson}
\href{https://github.com/google/gson}{Gson 2.8.5} posibilita la importación y exportación de textos JSON a partir de los métodos \textit{toJson()} y \textit{fromJson()}.
...
\subsection{jsoup}
\href{https://jsoup.org/}{jsoup 1.11.3} es una librería que trabaja con textos HTML, desde la descarga en páginas web hasta su tratamiento y extracción de datos de forma sencilla y cómoda.
...
\href{https://www.threeten.org/threeten-extra/}{ThreeTen Extra 1.5.0} proporciona varias formas de medir el tiempo no disponibles en el paquete de Java Time. Las clases de ThreeTen Extra se complementa con Java Time

Ejemplos aplicados en el proyecto han sido la combinación de numero de semana y año, o trimestre y año.
