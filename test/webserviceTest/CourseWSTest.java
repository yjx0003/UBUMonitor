...
public class CourseWSTest {
	...
	public void setGradeReportLinesTest() {
		...
		assertEquals("Programaci�n", grl.getName());
		...
		String childrenList = "[Practicas, Teor�a, Tipo texto, Rango 10-20, Tipo escala, Mas escalas,"
				+ " Taller 1 (env�o), Taller 1 (evaluaci�n), Leccion Tema 1, Tarea con escala, Tarea con escala 2]";
