...
public class LogCreator {
	...
	/**
	 * Devuelve los componentes que no existen en el enum {@link es.ubu.lsi.ubumonitor.model.Component} al
	 * parsear logs
	 * 
	 * @return los componentes que no existen en el enum {@link es.ubu.lsi.ubumonitor.model.Component}
	 */
	...
	/**
	 * Devuelve los eventos que no existen en el enum {@link es.ubu.lsi.ubumonitor.model.Event} al parsear
	 * los logs
	 * 
	 * @return eventos que no existen en el enum {@link es.ubu.lsi.ubumonitor.model.Event}
	 */
