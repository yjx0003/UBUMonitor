...
public class LogTypes {
	...
	public static final Map<ComponentEvent, ReferencesLog> LOG_TYPES = new HashMap<ComponentEvent, ReferencesLog>(){
...

		{
			...
			put(ComponentEvent.get(Component.COMMENTS, Event.COMMENT_CREATED), UserCommentCmid.getInstance());
			put(ComponentEvent.get(Component.COMMENTS, Event.COMMENT_DELETED), UserCommentCmid.getInstance());
