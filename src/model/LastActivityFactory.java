...
public class LastActivityFactory {
	...
	static {
		SPAN_TIME.add(new LastActivity(0, 3, Color.GREEN));
		SPAN_TIME.add(new LastActivity(3, 7, Color.BLUE));
		SPAN_TIME.add(new LastActivity(7, 14, Color.ORANGE));
		SPAN_TIME.add(new LastActivity(14, Integer.MAX_VALUE, Color.RED));
	}
