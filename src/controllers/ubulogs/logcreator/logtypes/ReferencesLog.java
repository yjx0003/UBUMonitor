...
public abstract class ReferencesLog {
	...
	static {
		logTypes.put(new CompEventKey(Component.ASSIGNMENT, Event.A_SUBMISSION_HAS_BEEN_SUBMITTED),
				UserSubmissionCmid.getInstance());
		logTypes.put(new CompEventKey(Component.ASSIGNMENT, Event.ALL_THE_SUBMISSIONS_ARE_BEING_DOWNLOADED),
				UserCmid.getInstance());
		logTypes.put(new CompEventKey(Component.ASSIGNMENT, Event.ASSIGNMENT_OVERRIDE_CREATED),
				UserOverrideCmidAffected.getInstance());
		logTypes.put(new CompEventKey(Component.ASSIGNMENT, Event.ASSIGNMENT_OVERRIDE_DELETED),
				UserOverrideCmidAffected.getInstance());
		...
		logTypes.put(new CompEventKey(Component.ASSIGNMENT, Event.SUBMISSION_CONFIRMATION_FORM_VIEWED),
				UserCmid.getInstance());
		logTypes.put(new CompEventKey(Component.ASSIGNMENT, Event.SUBMISSION_FORM_VIEWED), UserCmid.getInstance());
		logTypes.put(new CompEventKey(Component.ASSIGNMENT, Event.THE_STATUS_OF_THE_SUBMISSION_HAS_BEEN_UPDATED),
				UserSubmissionCmid.getInstance());
		logTypes.put(new CompEventKey(Component.ASSIGNMENT, Event.THE_STATUS_OF_THE_SUBMISSION_HAS_BEEN_VIEWED),
				UserCmid.getInstance());
		logTypes.put(new CompEventKey(Component.ASSIGNMENT, Event.THE_SUBMISSION_HAS_BEEN_GRADED),
				UserSubmissionAffectedCmid.getInstance());
		logTypes.put(
				new CompEventKey(Component.ASSIGNMENT, Event.THE_USER_HAS_ACCEPTED_THE_STATEMENT_OF_THE_SUBMISSION),
				UserSubmissionCmid.getInstance());
...
//		logTypes.put(new CompEventKey(Component.CHOICE, Event.CHOICE_ANSWER_ADDED), null);
		...
		logTypes.put(new CompEventKey(Component.CHOICE, Event.COURSE_MODULE_INSTANCE_LIST_VIEWED),
				UserCourse.getInstance());
		...
		logTypes.put(new CompEventKey(Component.FEEDBACK, Event.COURSE_MODULE_INSTANCE_LIST_VIEWED),
				UserCourse.getInstance());

		logTypes.put(new CompEventKey(Component.FILE, Event.COURSE_MODULE_VIEWED), UserCmid.getInstance());

		logTypes.put(new CompEventKey(Component.FILE_SUBMISSIONS, Event.A_FILE_HAS_BEEN_UPLOADED),
				UserSubmissionCmid.getInstance());
		logTypes.put(new CompEventKey(Component.FILE_SUBMISSIONS, Event.SUBMISSION_CREATED),
				UserFilesCmid.getInstance());
		logTypes.put(new CompEventKey(Component.FILE_SUBMISSIONS, Event.SUBMISSION_UPDATED),
				UserFilesCmid.getInstance());
		...
		logTypes.put(new CompEventKey(Component.FOLDER, Event.ZIP_ARCHIVE_OF_FOLDER_DOWNLOADED),
				UserCmid.getInstance());

		logTypes.put(new CompEventKey(Component.FORUM, Event.COURSE_MODULE_INSTANCE_LIST_VIEWED),
				UserCourse.getInstance());
		...
		logTypes.put(new CompEventKey(Component.FORUM, Event.SOME_CONTENT_HAS_BEEN_POSTED),
				UserPostDiscussionCmid.getInstance());
		...
		logTypes.put(new CompEventKey(Component.OPENDOCUMENT_SPREADSHEET, Event.OPENDOCUMENT_GRADE_EXPORTED),
				User.getInstance());

		logTypes.put(new CompEventKey(Component.OVERVIEW_REPORT, Event.GRADE_OVERVIEW_REPORT_VIEWED),
				User.getInstance());
		...
		logTypes.put(new CompEventKey(Component.QUIZ, Event.COURSE_MODULE_INSTANCE_LIST_VIEWED),
				UserCourse.getInstance());
		...
		logTypes.put(new CompEventKey(Component.QUIZ, Event.QUIZ_ATTEMPT_REVIEWED),
				UserAttemptAffectedCmid.getInstance());
		...
		logTypes.put(new CompEventKey(Component.QUIZ, Event.QUIZ_ATTEMPT_SUMMARY_VIEWED),
				UserAttemptAffectedCmid.getInstance());
		logTypes.put(new CompEventKey(Component.QUIZ, Event.QUIZ_ATTEMPT_VIEWED),
				UserAttemptAffectedCmid.getInstance());
		...
		logTypes.put(new CompEventKey(Component.SINGLE_VIEW, Event.GRADE_SINGLE_VIEW_REPORT_VIEWED),
				User.getInstance());

		logTypes.put(new CompEventKey(Component.SUBMISSION_COMMENTS, Event.COMMENT_CREATED),
				UserCommentSubmissionCmid.getInstance());
		logTypes.put(new CompEventKey(Component.SUBMISSION_COMMENTS, Event.COMMENT_DELETED),
				UserCommentSubmissionCmid.getInstance());
		...
		logTypes.put(new CompEventKey(Component.SYSTEM, Event.COURSE_ACTIVITY_COMPLETION_UPDATED),
				UserCmidAffected.getInstance());
		...
		logTypes.put(new CompEventKey(Component.SYSTEM, Event.COURSE_MODULE_INSTANCE_LIST_VIEWED),
				UserCourse.getInstance());
		logTypes.put(new CompEventKey(Component.SYSTEM, Event.COURSE_MODULE_UPDATED), UserCmid.getInstance());
		logTypes.put(new CompEventKey(Component.SYSTEM, Event.COURSE_RESET_ENDED),
				controllers.ubulogs.logcreator.logtypes.Course.getInstance());
		...
		logTypes.put(new CompEventKey(Component.SYSTEM, Event.COURSE_USER_REPORT_VIEWED),
				UserCourseAffected.getInstance());
...
//		logTypes.put(new CompEventKey(Component.SYSTEM, Event.USER_GRADED), null);
		...
		logTypes.put(new CompEventKey(Component.SYSTEM, Event.USER_UNENROLLED_FROM_COURSE),
				UserAffectedCourse.getInstance());
