...
\begin{enumerate}
	...
	\imagen{elegir_jdl}{Elegir la descarga de JDK.}
	...
	\imagen{descarga_java}{Descarga del JDK 8}
...
\begin{enumerate}
	...
	\imagen{descargar_eclipse}{Descarga del paquete de Eclipse.}
	\item Pulsamos el botón de descarga \textbf{Download}.
	\imagen{boton_descarga_eclipse}{Pulsar el botón de descarga.}
...
\imagen{descargar_scene_builder}{Aceptar la licencia de Oracle BSD y descargr.}
...
\begin{enumerate}
	...
	\imagen{api_moodle}{Acceso al listado de funciones del servicio web de Moodle.}
	\item Bajamos abajo hasta la fila de \textbf{Servicios Web} y accedemos a \textbf{Documentación API}-
	\imagen{documentacion_api_moodle}{Acceder a la Documentación API.}
	...
	\imagen{listado_de_funciones}{Listado de funciones del servicio web de Moodle.}
\end{enumerate}
...
\imagen{diagrama_factory}{Diagrama de clases implementado el patrón Fábrica}
...
\imagen{runnable_jar_2}{Configuración del Runnable JAR.}
