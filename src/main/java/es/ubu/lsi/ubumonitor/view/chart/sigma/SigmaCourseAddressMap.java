...
public class SigmaCourseAddressMap extends Plotly {


	private EnrolledUserStudentMapping enrolledUserStudentMapping;
	
	public SigmaCourseAddressMap(MainController mainController, EnrolledUserStudentMapping enrolledUserStudentMapping) {
		super(mainController, ChartType.COURSE_ADDRESS_MAP);
	...
	public void exportCSV(String path) throws IOException {
		...
		try (CSVPrinter printer = new CSVPrinter(getWritter(path),
				CSVFormat.DEFAULT.withHeader("userid", "username", "courseAddress", "zipCode", "province", "autonomousCommunity"))) {
	...
	public static Map<AutonomousCommunity, Map<Province, List<Student>>> getProvincesStudent(List<Student> students) {
		...
		for (Student student : students) {
			String provinceZipCode = SigmaUsualAddressMap.getProviceZipCode(student.getCourseAddress());
