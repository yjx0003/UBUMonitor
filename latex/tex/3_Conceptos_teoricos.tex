...
\imagenflotante{course_modules}{Ejemplos de módulos del curso que actividades y recursos.}
...
\begin{itemize}
	...
	\imagenflotante{modname}{Extracto de la función del servicio web}
	\item Mediante el enlace al crear un módulo del curso. Figura \ref{fig:modnamelink}
	\imagenflotante{modnamelink}{Enlace que se genera mientras se crea el módulo}
...
\tablaSmall{Tabla de los diferentes tipos de módulos.}{l c c c c}{herramientasportipodeuso}
...
\imagenflotante{item_calificacion}{Ejemplo de una tabla con varios Ítem de calificación.}

\imagenflotante{alternativa_grade_item}{Ejemplo de tabla parcial con los usuarios e Ítems de calificación}
...
\imagenflotante{course_categories}{Ejemplo de categorías del curso enmarcados en rojo.}
...
\imagenflotante{group_added}{Ejemplo de entrada de registro}
