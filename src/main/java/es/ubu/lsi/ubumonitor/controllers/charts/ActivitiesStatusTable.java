...
public class ActivitiesStatusTable extends Tabulator {
	...
	public String createColumns(List<CourseModule> courseModules) {
		...
		for (CourseModule courseModule : courseModules) {
			...
			addKeyValue(jsObject, "topCalc", "function(n,r,c){var f=0;return n.forEach(function(n){n&&f++}),f+'/'+n.length+' ('+(f/n.length||0).toLocaleString(locale,{style:'percent',maximumFractionDigits:2})+')'}");
